...
export const FlagIconData = [
  ...
  { abbrivation: "ai", name: "Anguilla Flag" },
  { abbrivation: "al", name: "Albania Flag" },
  { abbrivation: "am", name: "Armenia Flag" },
  { abbrivation: "ao", name: "Angola Flag" },
  { abbrivation: "ar", name: "Argentina Flag" },
  { abbrivation: "as", name: "American Samoa Flag" },
  { abbrivation: "at", name: "Austria Flag" },
  { abbrivation: "au", name: "Australia Flag" },
  { abbrivation: "aw", name: "Aruba Flag" },
  { abbrivation: "ax", name: "Aland Islands Flag" },
  { abbrivation: "az", name: "Azerbaijan Flag" },
  { abbrivation: "ba", name: "Bosnia and Herzegovina Flag" },
  { abbrivation: "bb", name: "Barbados Flag" },
  { abbrivation: "bd", name: "Bangladesh Flag" },
  { abbrivation: "be", name: "Belgium Flag" },
  { abbrivation: "bf", name: "Burkina Faso Flag" },
  { abbrivation: "bg", name: "Bulgaria Flag" },
  { abbrivation: "bh", name: "Bahrain Flag" },
  { abbrivation: "bi", name: "Burundi Flag" },
  { abbrivation: "bj", name: "Benin Flag" },
  { abbrivation: "bl", name: "Saint Barthélemy Flag" },
  { abbrivation: "bm", name: "Bermuda Flag" },
  { abbrivation: "bn", name: "Brunei Darussalam Flag" },
  { abbrivation: "bo", name: "Bolivia (Plurinational State of) Flag" },
  { abbrivation: "bq", name: "Bonaire, Sint Eustatius and Saba Flag" },
  { abbrivation: "br", name: "Brazil Flag" },
  { abbrivation: "bs", name: "Bahamas Flag" },
  { abbrivation: "bt", name: "Bhutan Flag" },
  { abbrivation: "bw", name: "Botswana Flag" },
  { abbrivation: "by", name: "Belarus Flag" },
  { abbrivation: "bz", name: "Belize Flag" },
  { abbrivation: "ca", name: "Canada Flag" },
  { abbrivation: "cc", name: "Cocos (Keeling) Islands Flag" },
  { abbrivation: "cd", name: "Democratic Republic of the Congo Flag" },
  { abbrivation: "cf", name: "Central African Republic Flag" },
  { abbrivation: "cg", name: "Republic of the Congo Flag" },
  { abbrivation: "ch", name: "Switzerland Flag" },
  { abbrivation: "ci", name: "Côte d Ivoire Flag" },
  { abbrivation: "ck", name: "Cook Islands Flag" },
  { abbrivation: "cl", name: "Chile Flag" },
  { abbrivation: "cm", name: "Cameroon Flag" },
  { abbrivation: "cn", name: "China Flag" },
  { abbrivation: "co", name: "Colombia Flag" },
  { abbrivation: "cr", name: "Costa Rica Flag" },
  { abbrivation: "cu", name: "Cuba Flag" },
  { abbrivation: "cv", name: "Cabo Verde Flag" },
  { abbrivation: "cw", name: "Curaçao Flag" },
  { abbrivation: "cx", name: "Christmas Island Flag" },
  { abbrivation: "cy", name: "Cyprus Flag" },
  { abbrivation: "cz", name: "Czech Republic Flag" },
  { abbrivation: "de", name: "Germany Flag" },
  { abbrivation: "dj", name: "Djibouti Flag" },
  { abbrivation: "dk", name: "Denmark Flag" },
  { abbrivation: "dm", name: "Dominica Flag" },
  { abbrivation: "do", name: "Dominican Republic Flag" },
  { abbrivation: "dz", name: "Algeria Flag" },
  { abbrivation: "ec", name: "Ecuador Flag" },
  { abbrivation: "ee", name: "Estonia Flag" },
  { abbrivation: "eg", name: "Egypt Flag" },
  { abbrivation: "eh", name: "Western Sahara Flag" },
  { abbrivation: "er", name: "Eritrea Flag" },
  { abbrivation: "es", name: "Spain Flag" },
  { abbrivation: "et", name: "Ethiopia Flag" },
  { abbrivation: "fi", name: "Finland Flag" },
  { abbrivation: "fj", name: "Fiji Flag" },
  { abbrivation: "fk", name: "Falkland Islands Flag" },
  { abbrivation: "fm", name: "Federated States of Micronesia Flag" },
  { abbrivation: "fo", name: "Faroe Islands Flag" },
  { abbrivation: "fr", name: "France Flag" },
  { abbrivation: "ga", name: "Gabon Flag" },
  { abbrivation: "gb", name: "United Kingdom Flag" },
  { abbrivation: "gd", name: "Grenada Flag" },
  { abbrivation: "ge", name: "Georgia Flag" },
  { abbrivation: "gf", name: "French Guiana Flag" },
  { abbrivation: "gg", name: "Guernsey Flag" },
  { abbrivation: "gh", name: "Ghana Flag" },
  { abbrivation: "gi", name: "Gibraltar Flag" },
  { abbrivation: "gl", name: "Greenland Flag" },
  { abbrivation: "gm", name: "Gambia Flag" },
  { abbrivation: "gn", name: "Guinea Flag" },
  ...
  { abbrivation: "gy", name: "Guyana Flag" },
  { abbrivation: "hk", name: "Hong Kong Flag" },
  { abbrivation: "hn", name: "Honduras Flag" },
  { abbrivation: "hr", name: "Croatia Flag" },
  { abbrivation: "ht", name: "Haiti Flag" },
  { abbrivation: "hu", name: "Hungary Flag" },
  { abbrivation: "id", name: "Indonesia Flag" },
  { abbrivation: "ie", name: "Ireland Flag" },
  { abbrivation: "il", name: "Israel Flag" },
  { abbrivation: "im", name: "Isle of Man Flag" },
  { abbrivation: "io", name: "British Indian Ocean Territory Flag" },
  { abbrivation: "iq", name: "Iraq Flag" },
  { abbrivation: "ir", name: "Iran (Islamic Republic of) Flag" },
  { abbrivation: "is", name: "Iceland Flag" },
  { abbrivation: "it", name: "Italy Flag" },
  { abbrivation: "je", name: "Jersey Flag" },
  { abbrivation: "jm", name: "Jamaica Flag" },
  { abbrivation: "jo", name: "Jordan Flag" },
  { abbrivation: "jp", name: "Japan Flag" },
  { abbrivation: "ke", name: "Kenya Flag" },
  { abbrivation: "kg", name: "Kyrgyzstan Flag" },
  { abbrivation: "kh", name: "Cambodia Flag" },
  { abbrivation: "ki", name: "Kiribati Flag" },
  { abbrivation: "km", name: "Comoros Flag" },
  { abbrivation: "kn", name: "Saint Kitts and Nevis Flag" },
  { abbrivation: "kp", name: "North Korea Flag" },
  { abbrivation: "kr", name: "South Korea Flag" },
  { abbrivation: "kw", name: "Kuwait Flag" },
  { abbrivation: "ky", name: "Cayman Islands Flag" },
  { abbrivation: "kz", name: "Kazakhstan Flag" },
  { abbrivation: "la", name: "Laos Flag" },
  { abbrivation: "lb", name: "Lebanon Flag" },
  { abbrivation: "lc", name: "Saint Lucia Flag" },
  { abbrivation: "li", name: "Liechtenstein Flag" },
  { abbrivation: "lk", name: "Sri Lanka Flag" },
  { abbrivation: "lr", name: "Liberia Flag" },
  { abbrivation: "ls", name: "Lesotho Flag" },
  { abbrivation: "lt", name: "Lithuania Flag" },
  { abbrivation: "lu", name: "Luxembourg Flag" },
  { abbrivation: "lv", name: "Latvia Flag" },
  { abbrivation: "ly", name: "Libya Flag" },
  { abbrivation: "ma", name: "Morocco Flag" },
  { abbrivation: "mc", name: "Monaco Flag" },
  { abbrivation: "md", name: "Moldova Flag" },
  { abbrivation: "me", name: "Montenegro Flag" },
  { abbrivation: "mf", name: "Saint Martin Flag" },
  { abbrivation: "mg", name: "Madagascar Flag" },
  { abbrivation: "mh", name: "Marshall Islands Flag" },
  { abbrivation: "mk", name: "Former Yugoslav Republic of Macedonia Flag" },
  { abbrivation: "ml", name: "Mali Flag" },
  { abbrivation: "mm", name: "Myanmar Flag" },
  { abbrivation: "mn", name: "Mongolia Flag" },
  { abbrivation: "mo", name: "Macau Flag" },
  { abbrivation: "mp", name: "Northern Mariana Islands Flag" },
  { abbrivation: "mq", name: "Martinique Flag" },
  { abbrivation: "mr", name: "Mauritania Flag" },
  { abbrivation: "ms", name: "Montserrat Flag" },
  { abbrivation: "mt", name: "Malta Flag" },
  { abbrivation: "mu", name: "Mauritius Flag" },
  { abbrivation: "mv", name: "Maldives Flag" },
  { abbrivation: "mw", name: "Malawi Flag" },
  { abbrivation: "mx", name: "Mexico Flag" },
  { abbrivation: "my", name: "Malaysia Flag" },
  { abbrivation: "mz", name: "Mozambique Flag" },
  { abbrivation: "na", name: "Namibia Flag" },
  { abbrivation: "nc", name: "New Caledonia Flag" },
  { abbrivation: "ne", name: "Niger Flag" },
  { abbrivation: "nf", name: "Norfolk Island Flag" },
  { abbrivation: "ng", name: "Nigeria Flag" },
  { abbrivation: "ni", name: "Nicaragua Flag" },
  { abbrivation: "nl", name: "Netherlands Flag" },
  { abbrivation: "no", name: "Norway Flag" },
  { abbrivation: "np", name: "Nepal Flag" },
  { abbrivation: "nr", name: "Nauru Flag" },
  { abbrivation: "nu", name: "Niue Flag" },
  { abbrivation: "nz", name: "New Zealand Flag" },
  { abbrivation: "om", name: "Oman Flag" },
  { abbrivation: "pa", name: "Panama Flag" },
  { abbrivation: "pe", name: "Peru Flag" },
  { abbrivation: "pf", name: "French Polynesia Flag" },
  { abbrivation: "pg", name: "Papua New Guinea Flag" },
  { abbrivation: "ph", name: "Philippines Flag" },
  { abbrivation: "pk", name: "Pakistan Flag" },
  { abbrivation: "pl", name: "Poland Flag" },
  { abbrivation: "pm", name: "Saint Pierre and Miquelon Flag" },
  { abbrivation: "pn", name: "Pitcairn Flag" },
  { abbrivation: "pr", name: "Puerto Rico Flag" },
  { abbrivation: "ps", name: "State of Palestine Flag" },
  { abbrivation: "pt", name: "Portugal Flag" },
  { abbrivation: "pw", name: "Palau Flag" },
  { abbrivation: "py", name: "Paraguay Flag" },
  { abbrivation: "qa", name: "Qatar Flag" },
  { abbrivation: "re", name: "Réunion Flag" },
  { abbrivation: "ro", name: "Romania Flag" },
  { abbrivation: "rs", name: "Serbia Flag" },
  { abbrivation: "ru", name: "Russia Flag" },
  { abbrivation: "rw", name: "Rwanda Flag" },
  { abbrivation: "sa", name: "Saudi Arabia Flag" },
  { abbrivation: "sb", name: "Solomon Islands Flag" },
  { abbrivation: "sc", name: "Seychelles Flag" },
...
export const WeatherIconList = [
        ...
        <g className="climacon_iconWrap climacon_iconWrap-sun">
          <g className="climacon_componentWrap climacon_componentWrap-sun">
            <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M72.03,51.999h-3.998c-1.105,0-2-0.896-2-1.999s0.895-2,2-2h3.998c1.104,0,2,0.896,2,2S73.136,51.999,72.03,51.999z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northEast" d="M64.175,38.688c-0.781,0.781-2.049,0.781-2.828,0c-0.781-0.781-0.781-2.047,0-2.828l2.828-2.828c0.779-0.781,2.047-0.781,2.828,0c0.779,0.781,0.779,2.047,0,2.828L64.175,38.688z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-north" d="M50.034,34.002c-1.105,0-2-0.896-2-2v-3.999c0-1.104,0.895-2,2-2c1.104,0,2,0.896,2,2v3.999C52.034,33.106,51.136,34.002,50.034,34.002z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northWest" d="M35.893,38.688l-2.827-2.828c-0.781-0.781-0.781-2.047,0-2.828c0.78-0.781,2.047-0.781,2.827,0l2.827,2.828c0.781,0.781,0.781,2.047,0,2.828C37.94,39.469,36.674,39.469,35.893,38.688z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-west" d="M34.034,50c0,1.104-0.896,1.999-2,1.999h-4c-1.104,0-1.998-0.896-1.998-1.999s0.896-2,1.998-2h4C33.14,48,34.034,48.896,34.034,50z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-southWest" d="M35.893,61.312c0.781-0.78,2.048-0.78,2.827,0c0.781,0.78,0.781,2.047,0,2.828l-2.827,2.827c-0.78,0.781-2.047,0.781-2.827,0c-0.781-0.78-0.781-2.047,0-2.827L35.893,61.312z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-south" d="M50.034,65.998c1.104,0,2,0.895,2,1.999v4c0,1.104-0.896,2-2,2c-1.105,0-2-0.896-2-2v-4C48.034,66.893,48.929,65.998,50.034,65.998z"></path>
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-southEast" d="M64.175,61.312l2.828,2.828c0.779,0.78,0.779,2.047,0,2.827c-0.781,0.781-2.049,0.781-2.828,0l-2.828-2.827c-0.781-0.781-0.781-2.048,0-2.828C62.126,60.531,63.392,60.531,64.175,61.312z"></path>
            </g>
            <g className="climacon_componentWrap climacon_componentWrap_sunBody" clip-path="url(#sunFillClip)">
              <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="50.034" cy="50" r="11.999"></circle>
            </g>
          </g>
        </g>
      </svg>
        ...
        <g className="climacon_iconWrap climacon_iconWrap-sunFill">
          <g className="climacon_componentWrap climacon_componentWrap-sun">
            ...
            <g className="climacon_componentWrap climacon_componentWrap_sunBody">
              ...
              <circle className="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="50.034" cy="50" r="7.999" />
            </g>
          </g>
        </g>
      </svg>
  ...
  {
    icon: (
      <svg version="1.1" id="moonfill" className="climacon climacon_moonFill" viewBox="15 15 70 70">
      ...
      <svg version="1.1" id="snowflakeFill" className="climacon climacon_snowflakeFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-snowflakeFill">
          <g className="climacon_componentWrap climacon_componentWrap-snowflake">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_snowflake" d="M59.659,46.733l-1.958,1.13c0.188,0.682,0.298,1.396,0.298,2.137c0,0.742-0.108,1.456-0.298,2.139l1.958,1.129c0.956,0.553,1.284,1.775,0.731,2.732c-0.553,0.956-1.774,1.284-2.731,0.73l-1.954-1.127c-1.003,1.02-2.277,1.766-3.705,2.133v2.263c0,1.104-0.896,2-2,2c-1.104,0-2-0.896-2-2v-2.263c-1.428-0.367-2.703-1.113-3.705-2.133l-1.954,1.127c-0.957,0.554-2.18,0.226-2.731-0.73c-0.553-0.957-0.225-2.18,0.731-2.732l1.958-1.129c-0.189-0.683-0.298-1.396-0.298-2.139c0-0.741,0.108-1.455,0.298-2.137l-1.958-1.13c-0.956-0.553-1.284-1.775-0.731-2.732c0.552-0.956,1.774-1.284,2.731-0.731l1.954,1.128c1.002-1.02,2.277-1.766,3.705-2.134v-2.262c0-1.104,0.896-2,2-2c1.104,0,2,0.896,2,2v2.262c1.428,0.368,2.702,1.114,3.705,2.134l1.954-1.128c0.957-0.553,2.18-0.225,2.731,0.731C60.943,44.958,60.615,46.181,59.659,46.733z" />
            <circle className="climacon_component climacon_component-fill climacon_component-fill_snowflake" fill="#FFFFFF" cx="50" cy="50" r="4" />
          </g>
        </g>
      </svg>
    ),
          ...
          <g clipPath="url(#cloudFillClip)">
            <g className="climacon_componentWrap climacon_componentWrap-sun climacon_componentWrap-sun_cloud">
              <g className="climacon_componentWrap climacon_componentWrap_sunSpoke">
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-orth" d="M80.029,43.611h-3.998c-1.105,0-2-0.896-2-1.999s0.895-2,2-2h3.998c1.104,0,2,0.896,2,2S81.135,43.611,80.029,43.611z" />
        ...
        <g className="climacon_iconWrap climacon_cloudSunFill-iconWrap">
          <g className="climacon_componentWrap climacon_componentWrap-sun climacon_componentWrap-sun_cloud">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
              <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="58.033" cy="41.612" r="11.999" />
              <circle className="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="58.033" cy="41.612" r="7.999" />
            </g>
          </g>
  ...
  {
    icon: (
      <svg version="1.1" id="cloudMoon" className="climacon climacon_cloudMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudMoonFill" className="climacon climacon_cloudMoonFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzle" className="climacon climacon_cloudDrizzle" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzle">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" d="M42.001,53.644c1.104,0,2,0.896,2,2v3.998c0,1.105-0.896,2-2,2c-1.105,0-2.001-0.895-2.001-2v-3.998C40,54.538,40.896,53.644,42.001,53.644z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M49.999,53.644c1.104,0,2,0.896,2,2v4c0,1.104-0.896,2-2,2s-1.998-0.896-1.998-2v-4C48.001,54.54,48.896,53.644,49.999,53.644z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M57.999,53.644c1.104,0,2,0.896,2,2v3.998c0,1.105-0.896,2-2,2c-1.105,0-2-0.895-2-2v-3.998C55.999,54.538,56.894,53.644,57.999,53.644z" />
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent-cloud">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleFill" className="climacon climacon_cloudDrizzleFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleSun" className="climacon climacon_cloudDrizzleSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleSunFill" className="climacon climacon_cloudDrizzleSunFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleMoon" className="climacon climacon_cloudDrizzleMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleMoonFill" className="climacon climacon_cloudDrizzleMoonFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleAlt" className="climacon climacon_cloudDrizzleAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleAltfill1" className="climacon climacon_cloudDrizzleFillAlt" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzleFillAlt">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" id="Drizzle-Left_1_1" d="M56.969,57.672l-2.121,2.121c-1.172,1.172-1.172,3.072,0,4.242c1.17,1.172,3.07,1.172,4.24,0c1.172-1.17,1.172-3.07,0-4.242L56.969,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M50.088,57.672l-2.119,2.121c-1.174,1.172-1.174,3.07,0,4.242c1.17,1.172,3.068,1.172,4.24,0s1.172-3.07,0-4.242L50.088,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M43.033,57.672l-2.121,2.121c-1.172,1.172-1.172,3.07,0,4.242s3.07,1.172,4.244,0c1.172-1.172,1.172-3.07,0-4.242L43.033,57.672z" />
          </g>
          <g className="climacon_componentWrap climacon_componentWrap_cloud">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleSunAlt" className="climacon climacon_cloudDrizzleSunAlt" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzleSunAlt">
          ...
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" id="Drizzle-Left_1_2" d="M56.969,57.672l-2.121,2.121c-1.172,1.172-1.172,3.072,0,4.242c1.17,1.172,3.07,1.172,4.24,0c1.172-1.17,1.172-3.07,0-4.242L56.969,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M50.088,57.672l-2.119,2.121c-1.174,1.172-1.174,3.07,0,4.242c1.17,1.172,3.068,1.172,4.24,0s1.172-3.07,0-4.242L50.088,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M43.033,57.672l-2.121,2.121c-1.172,1.172-1.172,3.07,0,4.242s3.07,1.172,4.244,0c1.172-1.172,1.172-3.07,0-4.242L43.033,57.672z" />
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent-cloud" clipPath="url(#cloudFillClip)">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleSunFillAlt" className="climacon climacon_cloudDrizzleSunFillAlt" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzleSunFillAlt">
          ...
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" id="Drizzle-Left_1_3" d="M56.969,57.672l-2.121,2.121c-1.172,1.172-1.172,3.072,0,4.242c1.17,1.172,3.07,1.172,4.24,0c1.172-1.17,1.172-3.07,0-4.242L56.969,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M50.088,57.672l-2.119,2.121c-1.174,1.172-1.174,3.07,0,4.242c1.17,1.172,3.068,1.172,4.24,0s1.172-3.07,0-4.242L50.088,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M43.033,57.672l-2.121,2.121c-1.172,1.172-1.172,3.07,0,4.242s3.07,1.172,4.244,0c1.172-1.172,1.172-3.07,0-4.242L43.033,57.672z" />
          </g>
          <g className="climacon_componentWrap climacon_componentWrap_cloud">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudDrizzleMoonAlt" className="climacon climacon_cloudDrizzleMoonAlt" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzleMoonAlt">
          ...
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" id="Drizzle-Left_1_4" d="M56.969,57.672l-2.121,2.121c-1.172,1.172-1.172,3.072,0,4.242c1.17,1.172,3.07,1.172,4.24,0c1.172-1.17,1.172-3.07,0-4.242L56.969,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M50.088,57.672l-2.119,2.121c-1.174,1.172-1.174,3.07,0,4.242c1.17,1.172,3.068,1.172,4.24,0s1.172-3.07,0-4.242L50.088,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M43.033,57.672l-2.121,2.121c-1.172,1.172-1.172,3.07,0,4.242s3.07,1.172,4.244,0c1.172-1.172,1.172-3.07,0-4.242L43.033,57.672z" />
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent-cloud" clipPath="url(#cloudFillClip)">
    ...
    icon: (
      <svg version="1.1" id="cloudDrizzleMoonFillAlt" className="climacon climacon_cloudDrizzleMoonFillAlt" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudDrizzleMoonFillAlt">
          ...
          <g className="climacon_wrapperComponent climacon_wrapperComponent-drizzle">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-left" id="Drizzle-Left_1_6" d="M56.969,57.672l-2.121,2.121c-1.172,1.172-1.172,3.072,0,4.242c1.17,1.172,3.07,1.172,4.24,0c1.172-1.17,1.172-3.07,0-4.242L56.969,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-middle" d="M50.088,57.672l-2.119,2.121c-1.174,1.172-1.174,3.07,0,4.242c1.17,1.172,3.068,1.172,4.24,0s1.172-3.07,0-4.242L50.088,57.672z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_drizzle climacon_component-stroke_drizzle-right" d="M43.033,57.672l-2.121,2.121c-1.172,1.172-1.172,3.07,0,4.242s3.07,1.172,4.244,0c1.172-1.172,1.172-3.07,0-4.242L43.033,57.672z" />
          </g>
          <g className="climacon_componentWrap climacon_componentWrap_cloud">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRain" className="climacon climacon_cloudRain" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainFill" className="climacon climacon_cloudRainFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainSun" className="climacon climacon_cloudRainSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainSunFill" className="climacon climacon_cloudRainSunFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainMoon" className="climacon climacon_cloudRainMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainAlt" className="climacon climacon_cloudRainAlt" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-cloudRainAlt">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-rain climacon_wrapperComponent-rain_alt">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_rain climacon_component-stroke_rain- alt" d="M50.001,58.568l3.535,3.535c1.95,1.953,1.95,5.119,0,7.07c-1.953,1.953-5.119,1.953-7.07,0c-1.953-1.951-1.953-5.117,0-7.07L50.001,58.568z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_rain climacon_component-stroke_rain- alt" d="M50.001,58.568l3.535,3.535c1.95,1.953,1.95,5.119,0,7.07c-1.953,1.953-5.119,1.953-7.07,0c-1.953-1.951-1.953-5.117,0-7.07L50.001,58.568z" />
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent_cloud" clipPath="url(#cloudFillClip)">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainAltFill" className="climacon climacon_cloudRainAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainSunAlt" className="climacon climacon_cloudSunRainAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainSunAltFill" className="climacon climacon_cloudSunRainAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainMoonAlt" className="climacon climacon_cloudMoonRainAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudRainMoonAltFill" className="climacon climacon_cloudMoonRainAltFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudRainSunAlt">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" d="M61.023,50.641c-6.627,0-11.999-5.372-11.999-11.998c0-6.627,5.372-11.999,11.999-11.999c0.755,0,1.491,0.078,2.207,0.212c-0.132,0.576-0.208,1.173-0.208,1.788c0,4.418,3.582,7.999,8,7.999c0.614,0,1.212-0.076,1.788-0.208c0.133,0.717,0.211,1.452,0.211,2.208C73.021,45.269,67.649,50.641,61.023,50.641z" />
            <path className="climacon_component climacon_component-fill climacon_component-fill_moon" fill="#FFFFFF" d="M59.235,30.851c-3.556,0.813-6.211,3.989-6.211,7.792c0,4.417,3.581,7.999,7.999,7.999c3.802,0,6.979-2.655,7.791-6.211C63.961,39.527,60.139,35.705,59.235,30.851z" />
  ...
  {
    icon: (
      <svg version="1.1" id="cloudHailAlt" className="climacon climacon_cloudHailAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudHailAltFill" className="climacon climacon_cloudHailAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudHailAltSun" className="climacon climacon_cloudHailAltSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudHailAltSunalt" className="climacon climacon_cloudHailAltSun" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudHailAltSun">
          <g className="climacon_componentWrap climacon_componentWrap-sun climacon_componentWrap-sun_cloud">
            <g className="climacon_componentWrap climacon_componentWrap_sunSpoke">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-north" d="M80.029,43.611h-3.998c-1.105,0-2-0.896-2-1.999s0.895-2,2-2h3.998c1.104,0,2,0.896,2,2S81.135,43.611,80.029,43.611z" />
  ...
  {
    icon: (
      <svg version="1.1" id="cloudHailAltMoon" className="climacon climacon_cloudHailAltMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnow" className="climacon climacon_cloudSnow" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowFill" className="climacon climacon_cloudSnowFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowSun" className="climacon climacon_cloudSnowSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowSunFill" className="climacon climacon_cloudSnowSunFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowMoon" className="climacon climacon_cloudSnowMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowMoonFill" className="climacon climacon_cloudSnowMoonFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowAltfill2" className="climacon climacon_cloudSnowAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowSunAlt" className="climacon climacon_cloudSnowSunAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowSunAltFill" className="climacon climacon_cloudSnowSunAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowAlt" className="climacon climacon_cloudSnowAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudSnowAltFill1" className="climacon climacon_cloudSnowAltFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" d="M61.023,50.641c-6.627,0-11.999-5.372-11.999-11.998c0-6.627,5.372-11.999,11.999-11.999c0.755,0,1.491,0.078,2.207,0.212c-0.132,0.576-0.208,1.173-0.208,1.788c0,4.418,3.582,7.999,8,7.999c0.614,0,1.212-0.076,1.788-0.208c0.133,0.717,0.211,1.452,0.211,2.208C73.021,45.269,67.649,50.641,61.023,50.641z" />
            <path className="climacon_component climacon_component-fill climacon_component-fill_moon" fill="#FFFFFF" d="M59.235,30.851c-3.556,0.813-6.211,3.989-6.211,7.792c0,4.417,3.581,7.999,7.999,7.999c3.802,0,6.979-2.655,7.791-6.211C63.961,39.527,60.139,35.705,59.235,30.851z" />
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFog" className="climacon climacon_cloudFog" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudFog">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-Fog">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_fogLine climacon_component-stroke_fogLine-top" d="M69.998,57.641H30.003c-1.104,0-2-0.895-2-2c0-1.104,0.896-2,2-2h39.995c1.104,0,2,0.896,2,2C71.998,56.746,71.104,57.641,69.998,57.641z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_fogLine climacon_component-stroke_fogLine-middle" d="M69.998,65.641H30.003c-1.104,0-2-0.896-2-2s0.896-2,2-2h39.995c1.104,0,2,0.896,2,2C71.998,64.744,71.104,65.641,69.998,65.641z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_fogLine climacon_component-stroke_fogLine-bottom" d="M30.003,69.639h39.995c1.104,0,2,0.896,2,2c0,1.105-0.896,2-2,2H30.003c-1.104,0-2-0.895-2-2C28.003,70.535,28.898,69.639,30.003,69.639z" />
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent-cloud">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogFill" className="climacon climacon_cloudFogFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudFog">
          <g className="climacon_wrapperComponent climacon_wrapperComponent-Fog">
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_fogLine climacon_component-stroke_fogLine-top" d="M69.998,57.641H30.003c-1.104,0-2-0.895-2-2c0-1.104,0.896-2,2-2h39.995c1.104,0,2,0.896,2,2C71.998,56.746,71.104,57.641,69.998,57.641z" />
            <path className="climacon_component climacon_component-stroke climacon_component-stroke_fogLine climacon_component-stroke_fogLine-middle" d="M69.998,65.641H30.003c-1.104,0-2-0.896-2-2s0.896-2,2-2h39.995c1.104,0,2,0.896,2,2C71.998,64.744,71.104,65.641,69.998,65.641z" />
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogSun" className="climacon climacon_cloudFogSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogSunFill" className="climacon climacon_cloudFogSunFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogMoon" className="climacon climacon_cloudFogMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogMoonFill" className="climacon climacon_cloudFogMoonFill" xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogAlt" className="climacon climacon_cloudFogAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogAltFill" className="climacon climacon_cloudFogAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogSunAlt" className="climacon climacon_cloudFogSunAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogSunAltFill" className="climacon climacon_cloudFogSunAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogMoonAlt" className="climacon climacon_cloudFogMoonAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudFogMoonAltFill" className="climacon climacon_cloudFogMoonAltFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningfill2" className="climacon climacon_cloudLightning" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningFill" className="climacon climacon_cloudLightningFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningfill1" className="climacon climacon_cloudLightningSun" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningSunFill" className="climacon climacon_cloudLightningSunFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudLightning">
          <g clipPath="url(#clip)">
            <g className="climacon_componentWrap climacon_componentWrap-sun climacon_componentWrap-sun_cloud">
              <g className="climacon_componentWrap climacon_componentWrap_sunSpoke">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningMoon" className="climacon climacon_cloudLightningMoon" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="cloudLightningMoonFill" className="climacon climacon_cloudLightningMoonFill" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="sunrise" className="climacon climacon_sunrise" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunrise">
          <g className="climacon_componentWrap climacon_componentWrap-sunrise">
            <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M32.003,54h-4c-1.104,0-2,0.896-2,2s0.896,2,2,2h4c1.104,0,2-0.896,2-2S33.106,54,32.003,54z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northEast" d="M38.688,41.859l-2.828-2.828c-0.781-0.78-2.047-0.78-2.828,0c-0.781,0.781-0.781,2.047,0,2.828l2.828,2.828c0.781,0.781,2.047,0.781,2.828,0C39.469,43.906,39.469,42.641,38.688,41.859z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-north" d="M50.001,40.002c1.104,0,1.999-0.896,1.999-2v-3.999c0-1.104-0.896-2-1.999-2c-1.105,0-2,0.896-2,2v3.999C48.001,39.106,48.896,40.002,50.001,40.002z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northWest" d="M66.969,39.031c-0.779-0.78-2.048-0.78-2.828,0l-2.828,2.828c-0.779,0.781-0.779,2.047,0,2.828c0.781,0.781,2.049,0.781,2.828,0l2.828-2.828C67.749,41.078,67.749,39.812,66.969,39.031z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-west" d="M71.997,54h-3.999c-1.104,0-1.999,0.896-1.999,2s0.896,2,1.999,2h3.999c1.104,0,2-0.896,2-2S73.104,54,71.997,54z" />
            </g>
            <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-arrow">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-up" d="M50.001,63.046c0.552,0,0.999-0.447,0.999-1v-3.827l2.536,2.535c0.39,0.391,1.022,0.391,1.414,0c0.39-0.391,0.39-1.023,0-1.414l-4.242-4.242c-0.391-0.391-1.024-0.391-1.414,0l-4.242,4.242c-0.391,0.391-0.391,1.023,0,1.414c0.391,0.391,1.023,0.391,1.414,0l2.535-2.535v3.827C49.001,62.599,49.448,63.046,50.001,63.046z" />
            </g>
  ...
  {
    icon: (
      <svg version="1.1" id="sunriseFill" className="climacon climacon_sunriseFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunriseFill">
          <g className="climacon_componentWrap climacon_componentWrap-sunrise">
            <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M71.997,57.999h-3.998c-1.104,0-2-0.896-2-1.999s0.896-2,2-2h3.998c1.104,0,2,0.896,2,2S73.104,57.999,71.997,57.999z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M64.143,44.688c-0.781,0.781-2.05,0.781-2.828,0c-0.781-0.781-0.781-2.047,0-2.828l2.828-2.828c0.778-0.781,2.047-0.781,2.828,0c0.778,0.781,0.778,2.047,0,2.828L64.143,44.688z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M50.001,40.002c-1.105,0-2-0.896-2-2v-3.999c0-1.104,0.895-2,2-2c1.104,0,2,0.896,2,2v3.999C52.001,39.106,51.104,40.002,50.001,40.002z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M35.86,44.688l-2.828-2.828c-0.781-0.781-0.781-2.047,0-2.828c0.781-0.781,2.047-0.781,2.828,0l2.828,2.828c0.781,0.781,0.781,2.047,0,2.828C37.907,45.469,36.641,45.469,35.86,44.688z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M34.002,56c0,1.104-0.896,1.999-2,1.999h-4c-1.104,0-1.999-0.896-1.999-1.999s0.896-2,1.999-2h4C33.107,54,34.002,54.896,34.002,56z" />
            </g>
            <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
              <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="50.001" cy="56" r="11.999" />
              <circle className="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="50.001" cy="56" r="7.999" />
            </g>
            <g className="climacon_wrapperComponent climacon_wrapperComponent-arrow">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-up" d="M50.001,63.046c0.552,0,0.999-0.447,0.999-1v-3.827l2.536,2.535c0.39,0.391,1.022,0.391,1.414,0c0.39-0.391,0.39-1.023,0-1.414l-4.242-4.242c-0.391-0.391-1.024-0.391-1.414,0l-4.242,4.242c-0.391,0.391-0.391,1.023,0,1.414c0.391,0.391,1.023,0.391,1.414,0l2.535-2.535v3.827C49.001,62.599,49.448,63.046,50.001,63.046z" />
            </g>
  ...
  {
    icon: (
      <svg version="1.1" id="sunset" className="climacon climacon_sunset" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunset">
          <g className="climacon_componentWrap climacon_componentWrap-sunset">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-arrow">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-down" d="M50,49.107c0.552,0,1,0.448,1,1.002v3.83l2.535-2.535c0.391-0.391,1.022-0.391,1.414,0c0.391,0.391,0.391,1.023,0,1.414l-4.242,4.242c-0.392,0.391-1.022,0.391-1.414,0l-4.242-4.242c-0.391-0.391-0.391-1.023,0-1.414c0.392-0.391,1.023-0.391,1.414,0L49,53.939v-3.83C49,49.555,49.447,49.107,50,49.107z" />
            </g>
            <g className="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_horizonLine" d="M59.999,63.999H40.001c-1.104,0-1.999,0.896-1.999,2s0.896,1.999,1.999,1.999h19.998c1.104,0,2-0.895,2-1.999S61.104,63.999,59.999,63.999z" />
            </g>
  ...
  {
    icon: (
      <svg version="1.1" id="sunsetFill" className="climacon climacon_sunsetFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunsetFill">
          <g className="climacon_componentWrap climacon_componentWrap-sunsetFill">
            <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-west" d="M71.997,57.999h-3.998c-1.104,0-2-0.896-2-1.999s0.896-2,2-2h3.998c1.104,0,2,0.896,2,2S73.104,57.999,71.997,57.999z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northWest" d="M64.143,44.688c-0.781,0.781-2.05,0.781-2.828,0c-0.781-0.781-0.781-2.047,0-2.828l2.828-2.828c0.778-0.781,2.047-0.781,2.828,0c0.778,0.781,0.778,2.047,0,2.828L64.143,44.688z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-north" d="M50.001,40.002c-1.105,0-2-0.896-2-2v-3.999c0-1.104,0.895-2,2-2c1.104,0,2,0.896,2,2v3.999C52.001,39.106,51.104,40.002,50.001,40.002z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northEast" d="M35.86,44.688l-2.828-2.828c-0.781-0.781-0.781-2.047,0-2.828c0.781-0.781,2.047-0.781,2.828,0l2.828,2.828c0.781,0.781,0.781,2.047,0,2.828C37.907,45.469,36.641,45.469,35.86,44.688z" />
              <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M34.002,56c0,1.104-0.896,1.999-2,1.999h-4c-1.104,0-1.999-0.896-1.999-1.999s0.896-2,1.999-2h4C33.107,54,34.002,54.896,34.002,56z" />
            </g>
            <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
              <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="50.001" cy="56" r="11.999" />
  ...
  {
    icon: (
      <svg version="1.1" id="sunriseAlt" className="climacon climacon_sunriseAlt" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-sunriseAlt">
          <g clipPath="url(#sunriseClip)">
            <g className="climacon_componentWrap climacon_componentWrap-sunriseAlt">
              <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M71.997,74.002h-3.999c-1.104,0-2-0.896-2-2c0-1.105,0.896-2,2-2h3.999c1.104,0,2,0.895,2,2C73.997,73.105,73.104,74.002,71.997,74.002z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M64.141,60.689c-0.781,0.78-2.048,0.78-2.828,0c-0.779-0.781-0.779-2.047,0-2.828l2.828-2.828c0.78-0.78,2.047-0.78,2.828,0c0.78,0.781,0.78,2.047,0,2.828L64.141,60.689z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M50,56.003c-1.104,0-1.999-0.896-1.999-2v-3.999c0-1.104,0.896-2,1.999-2s2,0.896,2,2v3.999C52,55.107,51.104,56.003,50,56.003z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M35.86,60.689l-2.828-2.828c-0.781-0.781-0.781-2.047,0-2.828c0.78-0.78,2.047-0.78,2.828,0l2.828,2.828c0.78,0.781,0.78,2.047,0,2.828C37.907,61.47,36.641,61.47,35.86,60.689z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M34.002,72.002c0,1.104-0.896,2-1.999,2h-4c-1.104,0-2-0.896-2-2c0-1.105,0.896-2,2-2h4C33.106,70.002,34.002,70.896,34.002,72.002z" />
              </g>
              <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
  ...
  {
    icon: (
      <svg version="1.1" id="sunriseAltFill" className="climacon climacon_sunriseAltFill" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-sunriseAltFill">
          <g clipPath="url(#sunriseFillClip)">
            <g className="climacon_componentWrap climacon_componentWrap-sunriseAlt">
              <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M72.31,77.999h-3.998c-1.104,0-2-0.896-2-1.999s0.896-2,2-2h3.998c1.104,0,2,0.896,2,2S73.416,77.999,72.31,77.999z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M64.455,64.688c-0.781,0.781-2.05,0.781-2.828,0c-0.781-0.78-0.781-2.047,0-2.828l2.828-2.827c0.778-0.781,2.047-0.781,2.828,0c0.778,0.78,0.778,2.047,0,2.827L64.455,64.688z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M50.313,60.002c-1.104,0-2-0.896-2-2v-3.999c0-1.104,0.896-2,2-2s2,0.896,2,2v3.999C52.313,59.105,51.416,60.002,50.313,60.002z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M36.172,64.688l-2.828-2.828c-0.781-0.78-0.781-2.047,0-2.827c0.781-0.781,2.047-0.781,2.828,0L39,61.859c0.781,0.781,0.781,2.048,0,2.828C38.22,65.469,36.954,65.469,36.172,64.688z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M34.314,76c0,1.104-0.896,1.999-2,1.999h-4c-1.104,0-1.999-0.896-1.999-1.999s0.896-2,1.999-2h4C33.419,74,34.314,74.896,34.314,76z" />
              </g>
              <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="50.313" cy="76" r="11.999" />
                <circle className="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="50.001" cy="76" r="7.999" />
              </g>
            </g>
          </g>
          <g className="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
  ...
  {
    icon: (
      <svg version="1.1" id="sunsetAltfill" className="climacon climacon_sunsetAlt" viewBox="15 15 70 70">
  ...
  {
    icon: (
      <svg version="1.1" id="sunsetAltFill" className="climacon climacon_sunsetAltFill" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-sunsetAltFill">
          <g clipPath="url(#sunriseFillClip)">
            <g className="climacon_componentWrap climacon_componentWrap-sunset climacon_componentWrap-sunsetAlt">
              <g className="climacon_componentWrap climacon_componentWrap-sunSpoke">
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east" d="M72.31,77.999h-3.998c-1.104,0-2-0.896-2-1.999s0.896-2,2-2h3.998c1.104,0,2,0.896,2,2S73.416,77.999,72.31,77.999z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northEast" d="M64.455,64.688c-0.781,0.781-2.05,0.781-2.828,0c-0.781-0.78-0.781-2.047,0-2.828l2.828-2.827c0.778-0.781,2.047-0.781,2.828,0c0.778,0.78,0.778,2.047,0,2.827L64.455,64.688z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-north" d="M50.313,60.002c-1.104,0-2-0.896-2-2v-3.999c0-1.104,0.896-2,2-2s2,0.896,2,2v3.999C52.313,59.105,51.416,60.002,50.313,60.002z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-northWest" d="M36.172,64.688l-2.828-2.828c-0.781-0.78-0.781-2.047,0-2.827c0.781-0.781,2.047-0.781,2.828,0L39,61.859c0.781,0.781,0.781,2.048,0,2.828C38.22,65.469,36.954,65.469,36.172,64.688z" />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-west" d="M34.314,76c0,1.104-0.896,1.999-2,1.999h-4c-1.104,0-1.999-0.896-1.999-1.999s0.896-2,1.999-2h4C33.419,74,34.314,74.896,34.314,76z" />
              </g>
              <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                <circle className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" cx="50.313" cy="76" r="11.999" />
                <circle className="climacon_component climacon_component-fill climacon_component-fill_sunBody" fill="#FFFFFF" cx="50.001" cy="76" r="7.999" />
